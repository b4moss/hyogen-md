...
| [v0.13.0](https://github.com/b4moss/hyogen-md/milestone/4) | 許可メソッド追加（`.slice` 等）、[見出し階層適合](./plans/v0.13.0/heading-hierarchy.md)（[#50](https://github.com/b4moss/hyogen-md/issues/50)） |
